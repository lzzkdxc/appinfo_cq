package com.chenqiang.cq_app_info.controller.developer;

import com.alibaba.fastjson.JSONArray;
import com.chenqiang.cq_app_info.pojo.*;
import com.mysql.jdbc.StringUtils;
import com.chenqiang.cq_app_info.pojo.*;
import com.chenqiang.cq_app_info.service.developer.AppCategoryService;
import com.chenqiang.cq_app_info.service.developer.AppInfoService;
	...
	public String addVersionSave(AppVersion appVersion,HttpSession session,HttpServletRequest request,
		...
		if(!attach.isEmpty()){
			...
			if(prefix.equalsIgnoreCase("apk")){//apk文件命名：apk名称+版本号+.apk
				...
				downloadLink = request.getContextPath()+ "/static/uploadfiles/" +apkFileName;
